...
/**
 * Legacy clock provider kept for compatibility during migration. The canonical
 * Clock bean and `ClockService` now live in the `trade-clock` module. This
 * class is intentionally not a @Configuration so it will not register beans.
 */
