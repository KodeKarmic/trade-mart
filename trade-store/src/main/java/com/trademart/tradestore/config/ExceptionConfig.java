...
public class ExceptionConfig {
  ...
  public ResponseEntity<Object> handleValidation(TradeValidationException ex, HttpServletRequest request) {
  ...
  public ResponseEntity<Object> handleRejected(
      com.trademart.tradestore.exception.TradeRejectedException ex,
