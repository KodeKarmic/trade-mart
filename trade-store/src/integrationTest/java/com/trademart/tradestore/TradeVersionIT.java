...
public class TradeVersionIT {
  ...
  void create_then_reject_lower_version_then_accept_higher_version() throws Exception {
    ...
    ResponseEntity<String> r1 =
        restTemplate.postForEntity(url, new HttpEntity<>(initial, headers), String.class);
    ...
    List<TradeHistory> h1 =
        tradeHistoryRepository.findAll().stream()
            .filter(h -> "VT-1".equals(h.getTradeId()))
    ...
    ResponseEntity<String> r2 =
        restTemplate.postForEntity(url, new HttpEntity<>(lower, headers), String.class);
    ...
    ResponseEntity<java.util.Map> r2map =
        restTemplate.postForEntity(url, new HttpEntity<>(lower, headers), java.util.Map.class);
    ...
    assertThat(bodyMap.get("message"))
    ...
    ResponseEntity<String> r3 =
        restTemplate.postForEntity(url, new HttpEntity<>(higher, headers), String.class);
